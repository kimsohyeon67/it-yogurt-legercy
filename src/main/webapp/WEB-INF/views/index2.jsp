...
<html lang="en">
    ...
    <body id="page-top"style="background-color: #F9F2ED">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" style="background-color: #91ACCC" id="mainNav">
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#features">매일지식</a></li>
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#download">게시판</a></li>
                    </ul>
        ...
        <section class="bg-light">
            <div class="container px-5" style="background-color:#ffffff">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <!-- Mashead text and app badges-->
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-1 lh-1 mb-3">요거트처럼 떠먹는 IT지식</h1>
                            <p class="lead fw-normal text-muted mb-5">지금 당장 구독하세요!</p>
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="px-5 px-sm-0">
                                    	<img class="img-fluid rounded-circ bg-light" style="border-radius: 50% !important;"  src="/image/logo.png">
                                    </div>
                                </div>
                            </div>
                        </div>
